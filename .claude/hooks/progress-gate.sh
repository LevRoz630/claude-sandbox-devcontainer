#!/bin/bash
# =============================================================================
# Progress gate — Stop hook
#
# Checks whether Claude has made meaningful progress (via git diff or recent
# commits) before allowing a session to stop. If stop_hook_active is true,
# tracks a continuation counter with a hard cap at 3 to prevent infinite loops.
#
# Exit 0 = allow stop
